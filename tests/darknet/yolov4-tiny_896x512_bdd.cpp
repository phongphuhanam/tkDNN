...
int main() {
    std::string bin_path  = "yolov4-tiny_896x512_bdd";
    ...
    std::string cfg_path = bin_path + "/yolov4-tiny_896x512_bdd.cfg";
    std::string name_path = bin_path + "/bdd-13.names";
    downloadWeightsifDoNotExist(input_bins[0], bin_path, 
    "https://data.msispp.duckdns.org/yolo/yolov4-tiny_896x512_bdd.zip");
